  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        <!-- Menu -->
            @include('admin.components.sidebar_left')
        <!-- / Menu -->
    ...
    <script src="{{ asset('admin/assets/vendor/libs/jquery/jquery-ui.min.js') }}"></script>
       <!-- Valid -->
    ...
    <!-- input mask jquery -->
    <script src="{{ asset('admin/libs/mask.min.js') }}"></script>
    <script>
        $.ajaxSetup({
            headers: {
