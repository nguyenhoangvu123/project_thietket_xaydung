                                                        ...
                                                        <div class="panel-body">
                                                            <table class="table table-responsive table-result-texture">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    {{-- <tr id="build-floor-10" class="tr-floor tr-floor-10">
                                                                        <th>Tầng hầm</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-35"
                                                                        class="tr-build-floor-child tr-floor-10 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="10" data-foor-child="35">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-35">
                                                                                <input id="cb-build-floor-child-35"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[35]"
                                                                                    type="checkbox" value="35">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-35"><input
                                                                                id="txt-build-floor-child-35"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[35]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-10"
                                                                            data-value="150">150%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-9" class="tr-floor tr-floor-9">
                                                                        <th>Tầng 1 (Trệt)</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-34"
                                                                        class="tr-build-floor-child tr-floor-9 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="9" data-foor-child="34">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-34">
                                                                                <input id="cb-build-floor-child-34"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[34]"
                                                                                    type="checkbox" value="34">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-34"><input
                                                                                id="txt-build-floor-child-34"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[34]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-9"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-8" class="tr-floor tr-floor-8">
                                                                        <th>Tầng lững</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-33"
                                                                        class="tr-build-floor-child tr-floor-8 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="8" data-foor-child="33">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-33">
                                                                                <input id="cb-build-floor-child-33"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[33]"
                                                                                    type="checkbox" value="33">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-33"><input
                                                                                id="txt-build-floor-child-33"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[33]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-8"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-32"
                                                                        class="tr-build-floor-child tr-floor-8 build-floor-child  hidden"
                                                                        data-floor="8" data-foor-child="32">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-32">
                                                                                <input id="cb-build-floor-child-32"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[32]"
                                                                                    type="checkbox" value="32">
                                                                                Ô thoáng
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-32"><input
                                                                                id="txt-build-floor-child-32"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[32]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-8"
                                                                            data-value="50">50%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-7" class="tr-floor tr-floor-7">
                                                                        <th>Tầng 2 (Lầu 1)</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-31"
                                                                        class="tr-build-floor-child tr-floor-7 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="7" data-foor-child="31">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-31">
                                                                                <input id="cb-build-floor-child-31"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[31]"
                                                                                    type="checkbox" value="31">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-31"><input
                                                                                id="txt-build-floor-child-31"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[31]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-7"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-30"
                                                                        class="tr-build-floor-child tr-floor-7 build-floor-child  hidden"
                                                                        data-floor="7" data-foor-child="30">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-30">
                                                                                <input id="cb-build-floor-child-30"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[30]"
                                                                                    type="checkbox" value="30">
                                                                                Ban công trước
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-30"><input
                                                                                id="txt-build-floor-child-30"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[30]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-7"
                                                                            data-value="70">70%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-6" class="tr-floor tr-floor-6">
                                                                        <th>Tầng 3 (Lầu 2)</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-29"
                                                                        class="tr-build-floor-child tr-floor-6 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="6" data-foor-child="29">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-29">
                                                                                <input id="cb-build-floor-child-29"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[29]"
                                                                                    type="checkbox" value="29">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-29"><input
                                                                                id="txt-build-floor-child-29"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[29]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-6"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-28"
                                                                        class="tr-build-floor-child tr-floor-6 build-floor-child  hidden"
                                                                        data-floor="6" data-foor-child="28">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-28">
                                                                                <input id="cb-build-floor-child-28"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[28]"
                                                                                    type="checkbox" value="28">
                                                                                Ban công trước
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-28"><input
                                                                                id="txt-build-floor-child-28"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[28]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-6"
                                                                            data-value="70">70%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-5" class="tr-floor tr-floor-5">
                                                                        <th>Tầng 4 (Lầu 3)</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-27"
                                                                        class="tr-build-floor-child tr-floor-5 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="5" data-foor-child="27">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-27">
                                                                                <input id="cb-build-floor-child-27"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[27]"
                                                                                    type="checkbox" value="27">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-27"><input
                                                                                id="txt-build-floor-child-27"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[27]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-5"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-26"
                                                                        class="tr-build-floor-child tr-floor-5 build-floor-child  hidden"
                                                                        data-floor="5" data-foor-child="26">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-26">
                                                                                <input id="cb-build-floor-child-26"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[26]"
                                                                                    type="checkbox" value="26">
                                                                                Ban công trước
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-26"><input
                                                                                id="txt-build-floor-child-26"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[26]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-5"
                                                                            data-value="70">70%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-4" class="tr-floor tr-floor-4">
                                                                        <th>Tầng 5 (Lầu 4)</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-25"
                                                                        class="tr-build-floor-child tr-floor-4 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="4" data-foor-child="25">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-25">
                                                                                <input id="cb-build-floor-child-25"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[25]"
                                                                                    type="checkbox" value="25">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-25"><input
                                                                                id="txt-build-floor-child-25"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[25]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-4"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-24"
                                                                        class="tr-build-floor-child tr-floor-4 build-floor-child  hidden"
                                                                        data-floor="4" data-foor-child="24">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-24">
                                                                                <input id="cb-build-floor-child-24"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[24]"
                                                                                    type="checkbox" value="24">
                                                                                Ban công trước
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-24"><input
                                                                                id="txt-build-floor-child-24"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[24]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-4"
                                                                            data-value="70">70%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-3" class="tr-floor tr-floor-3">
                                                                        <th>Tầng 6 (Lầu 5)</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-23"
                                                                        class="tr-build-floor-child tr-floor-3 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="3" data-foor-child="23">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-23">
                                                                                <input id="cb-build-floor-child-23"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[23]"
                                                                                    type="checkbox" value="23">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-23"><input
                                                                                id="txt-build-floor-child-23"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[23]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-3"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-22"
                                                                        class="tr-build-floor-child tr-floor-3 build-floor-child  hidden"
                                                                        data-floor="3" data-foor-child="22">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-22">
                                                                                <input id="cb-build-floor-child-22"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[22]"
                                                                                    type="checkbox" value="22">
                                                                                Ban công trước
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-22"><input
                                                                                id="txt-build-floor-child-22"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[22]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-3"
                                                                            data-value="70">70%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-2" class="tr-floor tr-floor-2">
                                                                        <th>Tầng thượng</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-21"
                                                                        class="tr-build-floor-child tr-floor-2 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="2" data-foor-child="21">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-21">
                                                                                <input id="cb-build-floor-child-21"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[21]"
                                                                                    type="checkbox" value="21">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-21"><input
                                                                                id="txt-build-floor-child-21"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[21]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-2"
                                                                            data-value="100">100%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-child-20"
                                                                        class="tr-build-floor-child tr-floor-2 build-floor-child  hidden"
                                                                        data-floor="2" data-foor-child="20">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-20">
                                                                                <input id="cb-build-floor-child-20"
                                                                                    class="cb-build-floor-child"
                                                                                    name="cbbuildFloorChild[20]"
                                                                                    type="checkbox" value="20">
                                                                                Sân thượng
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-20"><input
                                                                                id="txt-build-floor-child-20"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[20]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-2"
                                                                            data-value="70">70%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="build-floor-1" class="tr-floor tr-floor-1">
                                                                        <th>Mái</th>
                                                                        <th colspan="3">&nbsp;</th>
                                                                    </tr>
                                                                    <tr id="build-floor-child-19"
                                                                        class="tr-build-floor-child tr-floor-1 build-floor-child cb-first-build-floor-child hidden"
                                                                        data-floor="1" data-foor-child="19">
                                                                        <td>
                                                                            <label for="cb-build-floor-child-19">
                                                                                <input id="cb-build-floor-child-19"
                                                                                    class="cb-build-floor-child is_required"
                                                                                    checked="checked"
                                                                                    name="cbbuildFloorChild[19]"
                                                                                    type="checkbox" value="19">
                                                                                Diện tích sàn
                                                                            </label>
                                                                        </td>
                                                                        <td class="txt-build-floor-child-19"><input
                                                                                id="txt-build-floor-child-19"
                                                                                min="0"
                                                                                class="form-control form-control-sm txt-build-floor-child"
                                                                                placeholder="Nhập số"
                                                                                name="txtBuildFloorChild[19]"
                                                                                type="number" value=""></td>
                                                                        <td class="coefficient td-build-coefficient-1"
                                                                            data-value="40">40%</td>
                                                                        <td class="area">0</td>
                                                                    </tr>
                                                                    <tr id="resultEstimateBuild">
