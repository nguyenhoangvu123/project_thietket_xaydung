<div>
    ...
    <!-- Desktop Mobile -->
    <div class="hidden flex-col space-y-4" id="mobile-menu">
        <a href="#"
            class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Trang
            chủ</a>
        <a href="#"
            class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Giới
            thiệu</a>
        <div class="mobile-group_menu">
            <div class="flex justify-between items-center">
                <a href="#"
                    class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Xây
                    nhà trọn gói</a>
                <i
                    class="bx toggle-submenu bx-chevron-right text-[25px] text-[#4f4a4a] mr-[20px] transition-transform duration-300 ease-in-out"></i>
            </div>
            <div class="mobile-submenu hidden pl-[20px] transform  origin-top duration-50  ease-in-out">
                <div class="flex flex-col">
                    <a href="#"
                        class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Thiết
                        kế nhà</a>
                    <a href="#"
                        class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Thi
                        công xây dựng</a>
                </div>
            </div>
        </div>
        <a href="#"
            class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Dự
            án</a>
        <a href="#"
            class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Tin
            tức</a>
        <a href="#"
            class="text-gray-800 m-[0px] hover:text-red-500 px-[20px] text-[14px] py-[10px] border-b border-b-[#f7f6f6]">Liên
            hệ</a>
    </div>
</div>
